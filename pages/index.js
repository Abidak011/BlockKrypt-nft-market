...
export default function Home() 
{
  ...
  async function loadNFTs()
  {
    ...
    const marketContract = new ethers.Contract(nftmarketaddress,ContractNFTMarket.abi,provider);
  ...
  async function buyNFTs(nft)
  {
    ...
    const contract = new ethers.Contract(nftmarketaddress,ContractNFTMarket.abi,signer);
  ...
  if(loadingState === 'loaded' && !nfts.length) return (
    <h1 className='px-20 py-20 text-3xl'>No items in market place</h1>
  )
